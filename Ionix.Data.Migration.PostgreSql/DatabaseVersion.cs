namespace Ionix.Data.Migration.PostgreSql
{
    ...
    public class DatabaseVersion : DatabaseVersionBase
    {
        ...
        [DbSchema(ColumnName = "started_on")] public override DateTime? StartedOn { get; set; }

        [DbSchema(ColumnName = "completed_on")]
        public override DateTime? CompletedOn { get; set; }

        [DbSchema(ColumnName = "script")] public override string Script { get; set; }

        [DbSchema(ColumnName = "warning")] //amaç tablo da pk yok gibi uyarıların verilmesi
        public override string Warning { get; set; }

        [DbSchema(ColumnName = "exception")] public override string Exception { get; set; }

        [DbSchema(ColumnName = "built_in")] public override bool? BuiltIn { get; set; }
