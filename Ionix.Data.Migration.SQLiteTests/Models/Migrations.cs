    ...
    public sealed class Migration101 : Migration
    {
        ...
        public override void Sync(ICommandAdapter cmd)
        {
            ...
            appSettings.Add(new AppSetting()
                { Name = "FastReportsPath", Value = "c:\\", Module = "Module1", Enabled = true });
            appSettings.Add(new AppSetting()
                { Name = "WebApiAuthEnabled", Value = "true", Module = "Module1", Enabled = true });
            appSettings.Add(new AppSetting()
                { Name = "WebApiSessionTimeout", Value = "30", Module = "Module1", Enabled = true });
            cmd.BatchInsert(appSettings);


            Menu parent = new Menu()
                { Name = "Admin Panel", Route = null, OrderNum = null, ParentId = null, Visible = true, Icon = "apps" };
            cmd.Insert(parent);

            List<Menu> menus = new List<Menu>();
            menus.Add(new Menu()
            {
                Name = "Api Management", Route = "RoleActions", OrderNum = 1, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
            menus.Add(new Menu()
            {
                Name = "Roles", Route = "Roles", OrderNum = 2, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
            menus.Add(new Menu()
            {
                Name = "Menus", Route = "Menus", OrderNum = 3, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
            menus.Add(new Menu()
            {
                Name = "Roles&Menus", Route = "RolesMenus", OrderNum = 4, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
            menus.Add(new Menu()
            {
                Name = "Application Users", Route = "AppUsers", OrderNum = 5, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
            menus.Add(new Menu()
            {
                Name = "System Settings", Route = "AppSettings", OrderNum = 6, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
            menus.Add(new Menu()
            {
                Name = "Logs", Route = "Logs", OrderNum = 7, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
            menus.Add(new Menu()
            {
                Name = "Server Info", Route = "ServerInfo", OrderNum = 8, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
            menus.Add(new Menu()
            {
                Name = "Images&Sockets", Route = "SocketDemo", OrderNum = 9, ParentId = parent.MenuId, Visible = true,
                Icon = "fiber_manual_record"
            });
