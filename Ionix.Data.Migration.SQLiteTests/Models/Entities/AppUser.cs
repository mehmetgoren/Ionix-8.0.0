namespace Ionix.Data.Migration.SQLiteTests.Models
{
    ...
    public class AppUser
    {
        ...
        [DbSchema(MaxLength = 15)] public string IpAddress { get; set; }
        ...
        [DbSchema(MaxLength = 150)] public string Password { get; set; }

        public long? LoginCount { get; set; }

        [DbSchema(MaxLength = 50)] public string Title { get; set; }
