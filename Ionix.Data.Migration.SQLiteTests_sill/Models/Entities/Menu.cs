namespace Ionix.Data.Migration.SQLiteTests.Models
{
    ...
    public class Menu
    {
        ...
        [DbSchema(MaxLength = 50)] public string Route { get; set; }

        [DbSchema(MaxLength = 250)] public string Description { get; set; }
        ...
        [DbSchema(MaxLength = 20)] public string Icon { get; set; }


        [NotMapped] public List<Menu> Childs { get; set; } = new List<Menu>();
    }
}