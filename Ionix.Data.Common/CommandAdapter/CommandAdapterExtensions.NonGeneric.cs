namespace Ionix.Data.Common
{
    ...
    public static partial class CommandAdapterExtensions
    {
        ...
        public static object SelectByIdNonGeneric(this ICommandAdapter adapter, Type entityType,
        ...
        public static object SelectSingleNonGeneric(this ICommandAdapter adapter, Type entityType,
            SqlQuery extendedQuery) //extendedQuery null olabilir
        {
        ...
        public static IEnumerable SelectNonGeneric(this ICommandAdapter adapter, Type entityType,
        ...
        public static int UpsertNonGeneric(this ICommandAdapter adapter, object entity, string[] updatedFields,
            string[] insertFields)
        {
            if (null != adapter && null != entity)
            {
                Type entityType = entity.GetType();
                return (Int32)UpsertMethod(entityType)
                    .Invoke(adapter, new object[] { entity, updatedFields, insertFields });
            }
        ...
        public static int BatchUpdateNonGeneric(this ICommandAdapter adapter, IEnumerable entityList,
        ...
        public static int BatchInsertNonGeneric(this ICommandAdapter adapter, IEnumerable entityList,
        ...
        public static int BatchUpsertNonGeneric(this ICommandAdapter adapter, IEnumerable entityList,
            string[] updatedFields, string[] insertFields)
        {
            ...
            {
                Type entityType = first.GetType();
                return (Int32)BatchUpsertMethod(entityType)
                    .Invoke(adapter, new object[] { entityList, updatedFields, insertFields });
            }
