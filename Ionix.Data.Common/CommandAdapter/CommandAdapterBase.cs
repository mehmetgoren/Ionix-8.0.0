namespace Ionix.Data.Common
{
    ...
    public abstract class CommandAdapterBase : ICommandAdapter
    {
        ...
        public Task<(TEntity1, TEntity2, TEntity3, TEntity4)> QuerySingleAsync<TEntity1, TEntity2, TEntity3, TEntity4>(
            SqlQuery query)
        {
            var cmd = this.CreateSelectCommand();
        ...
        {
            var cmd = this.CreateSelectCommand();
            return cmd.QuerySingle<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5>(this.EntityMetaDataProvider,
                query);
        }

        public Task<(TEntity1, TEntity2, TEntity3, TEntity4, TEntity5)> QuerySingleAsync<TEntity1, TEntity2, TEntity3,
            TEntity4, TEntity5>(SqlQuery query)
        {
            var cmd = this.CreateSelectCommand();
            return cmd.QuerySingleAsync<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5>(this.EntityMetaDataProvider,
                query);
        }
        ...
        {
            var cmd = this.CreateSelectCommand();
            return cmd.QuerySingle<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6>(
                this.EntityMetaDataProvider, query);
        }

        public Task<(TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6)> QuerySingleAsync<TEntity1, TEntity2,
            TEntity3, TEntity4, TEntity5, TEntity6>(SqlQuery query)
        {
            var cmd = this.CreateSelectCommand();
            return cmd.QuerySingleAsync<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6>(
                this.EntityMetaDataProvider, query);
        }
        ...
        {
            var cmd = this.CreateSelectCommand();
            return cmd.QuerySingle<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6, TEntity7>(
                this.EntityMetaDataProvider, query);
        }

        public Task<(TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6, TEntity7)> QuerySingleAsync<TEntity1,
            TEntity2, TEntity3, TEntity4, TEntity5, TEntity6, TEntity7>(SqlQuery query)
        {
            var cmd = this.CreateSelectCommand();
            return cmd.QuerySingleAsync<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6, TEntity7>(
                this.EntityMetaDataProvider, query);
        }
        ...
        public Task<IList<(TEntity1, TEntity2, TEntity3, TEntity4)>> QueryAsync<TEntity1, TEntity2, TEntity3, TEntity4>(
            SqlQuery query)
        {
            var cmd = this.CreateSelectCommand();
        ...
        public Task<IList<(TEntity1, TEntity2, TEntity3, TEntity4, TEntity5)>> QueryAsync<TEntity1, TEntity2, TEntity3,
            TEntity4, TEntity5>(SqlQuery query)
        {
            var cmd = this.CreateSelectCommand();
        ...
        {
            var cmd = this.CreateSelectCommand();
            return cmd.Query<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6>(this.EntityMetaDataProvider,
                query);
        }

        public Task<IList<(TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6)>> QueryAsync<TEntity1, TEntity2,
            TEntity3, TEntity4, TEntity5, TEntity6>(SqlQuery query)
        {
            var cmd = this.CreateSelectCommand();
            return cmd.QueryAsync<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6>(
                this.EntityMetaDataProvider, query);
        }
        ...
        {
            var cmd = this.CreateSelectCommand();
            return cmd.Query<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6, TEntity7>(
                this.EntityMetaDataProvider, query);
        }

        public Task<IList<(TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6, TEntity7)>> QueryAsync<TEntity1,
            TEntity2, TEntity3, TEntity4, TEntity5, TEntity6, TEntity7>(SqlQuery query)
        {
            var cmd = this.CreateSelectCommand();
            return cmd.QueryAsync<TEntity1, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6, TEntity7>(
                this.EntityMetaDataProvider, query);
        }
        ...
        public virtual Task<int> BatchUpdateAsync<TEntity>(IEnumerable<TEntity> entityList,
        ...
        public virtual Task<int> BatchInsertAsync<TEntity>(IEnumerable<TEntity> entityList,
        ...
        public virtual int BatchUpsert<TEntity>(IEnumerable<TEntity> entityList, string[] updatedFields,
            string[] insertFields)
        {
        ...
        public virtual Task<int> BatchUpsertAsync<TEntity>(IEnumerable<TEntity> entityList, string[] updatedFields,
            string[] insertFields)
        {
            IBatchCommandUpsert cmd = this.CreateBatchCommandUpsert(updatedFields, insertFields);
