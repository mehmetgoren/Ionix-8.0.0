namespace Ionix.Data.Common
{
    ...
    public static class RepositoryExtension
    {
        ...
        public static int Upsert<TEntity>(this IRepository<TEntity> repository, TEntity entity,
            params Expression<Func<TEntity, object>>[] updatedFields)
        {
            return RepositoryExtension.Upsert(repository, entity, updatedFields,
        ...
        public static Task<int> UpsertAsync<TEntity>(this IRepository<TEntity> repository, TEntity entity,
            params Expression<Func<TEntity, object>>[] updatedFields)
        {
            return RepositoryExtension.UpsertAsync(repository, entity, updatedFields,
                (Expression<Func<TEntity, object>>[])null);
        }
        ...
        //Batch
        private static int BatchUpdate<TEntity>(IRepository<TEntity> repository, IEnumerable<TEntity> entityList,
        ...
        private static Task<int> BatchUpdateAsync<TEntity>(IRepository<TEntity> repository,
            IEnumerable<TEntity> entityList, string[] updatedFields)
        {
            if (null != repository)
            {
        ...
        public static Task<int> BatchUpdateAsync<TEntity>(this IRepository<TEntity> repository,
        ...
        private static int BatchInsert<TEntity>(IRepository<TEntity> repository, IEnumerable<TEntity> entityList,
            string[] insertFields)
        {
            if (null != repository)
            {
        ...
        private static Task<int> BatchInsertAsync<TEntity>(IRepository<TEntity> repository,
            IEnumerable<TEntity> entityList, string[] insertFields)
        {
            if (null != repository)
            {
        ...
        public static Task<int> BatchInsertAsync<TEntity>(this IRepository<TEntity> repository,
            IEnumerable<TEntity> entityList)
        {
        ...
        public static Task<int> BatchInsertAsync<TEntity>(this IRepository<TEntity> repository,
            IEnumerable<TEntity> entityList, params Expression<Func<TEntity, object>>[] insertFields)
        {
            string[] arr = CommandAdapterExtensions.ToStringArray(insertFields);
        ...
        private static int BatchUpsert<TEntity>(IRepository<TEntity> repository, IEnumerable<TEntity> entityList,
        ...
        private static Task<int> BatchUpsertAsync<TEntity>(IRepository<TEntity> repository,
            IEnumerable<TEntity> entityList, string[] updatedFields, string[] insertFields)
        {
            if (null != repository)
            {
        ...
        public static Task<int> BatchUpsertAsync<TEntity>(this IRepository<TEntity> repository,
            IEnumerable<TEntity> entityList, string[] updatedFields)
        {
        ...
        public static Task<int> BatchUpsertAsync<TEntity>(this IRepository<TEntity> repository,
            IEnumerable<TEntity> entityList, Expression<Func<TEntity, object>>[] updatedFields,
            Expression<Func<TEntity, object>>[] insertFields)
        {
            string[] updateArr = CommandAdapterExtensions.ToStringArray(updatedFields);
            string[] insertArr = CommandAdapterExtensions.ToStringArray(insertFields);
        ...
        {
            return RepositoryExtension.BatchUpsert(repository, entityList, updatedFields,
                (Expression<Func<TEntity, object>>[])null);
        }
        ...
        public static Task<int> BatchUpsertAsync<TEntity>(this IRepository<TEntity> repository,
            IEnumerable<TEntity> entityList, Expression<Func<TEntity, object>>[] updatedFields)
        {
            return RepositoryExtension.BatchUpsertAsync(repository, entityList, updatedFields,
                (Expression<Func<TEntity, object>>[])null);
        }
        //
    }
